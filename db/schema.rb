...
ActiveRecord::Schema.define(:version => 20131118163119) do
  ...
  create_table "admin_users_pages", :id => false, :force => true do |t|
    t.integer "admin_user.id"
    t.integer "page_id"
  end

  add_index "admin_users_pages", ["admin_user.id", "page_id"], :name => "index_admin_users_pages_on_admin_user.id_and_page_id"
